...
plugins=(git env svn misc maven tar gitflow lein rvm showoff amazon tmux vagrant cap git-extras vi-mode git-aliases nvm docker tmuxinator mix history-substring-search opsk librarian z)
